...
$npagmes=array($npag8,$npag7,$npag6,$npag,$npag4,$npag);
$fattmes=array($tot8,$tot7,$tot6,$tot5,$tot4,$tot2);
$permes=array(date("m/Y",strtotime('-5 months')),date("m/Y",strtotime('-4 months')),date("m/Y",strtotime('-3 months')),date("m/Y",strtotime('-2 months')),date("m/Y",strtotime('-1 months')),date("m/Y"));

$ar = array('fatt'=>$fattat,'fattmes'=>$fattmes,'npagmes'=>$npagmes,'permes'=>$permes,'alat' => $alat,'ades' => $ades,'tmed'=>$tmed,'npag'=>$npag,'pfat'=>$pfat,
